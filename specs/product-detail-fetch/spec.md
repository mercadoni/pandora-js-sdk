...
- [ ] `import { GetProductsBySKUFilter, GetSuggestedProductsFilter, GetProductRecommendationsFilter, ProductRecommendationType, Product } from '@mercadoni/pandora-js-sdk'` resolves with correct types.
