...
5. After publish, downstream apps install via `npm install @mercadoni/pandora-js-sdk@<new-version>`.
...
```typescript
import { Platform, HomeFilter, SignInInput } from '@mercadoni/pandora-js-sdk';
