const getSuggestedProductsQuery = `query GetSuggestedProducts($getSuggestedProductsInput: GetSuggestedProductsInput!) {
...
export default getSuggestedProductsQuery;
